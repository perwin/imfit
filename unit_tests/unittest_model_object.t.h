...
public:
  ...
  void testPrintParamsToString( void )
  {
    ...
    correctStrings1.push_back("#PA\t\t      0\t\t# deg (CCW from +y axis)\n");
    correctStrings1.push_back("#ell\t\t    0.5\n");
    correctStrings1.push_back("#I_0\t\t     50\t\t# counts/pixel\n");
    correctStrings1.push_back("#h\t\t     10\t\t# pixels\n");
    correctStrings1.push_back("#FUNCTION FlatSky\n");
    correctStrings1.push_back("#I_sky\t\t    100\t\t# counts/pixel\n");
    ...
    correctStrings2.push_back("#PA\t\t      0\t\t2,202\t\t# deg (CCW from +y axis)\n");
    correctStrings2.push_back("#ell\t\t    0.5\t\t3,203\n");
    correctStrings2.push_back("#I_0\t\t     50\t\t4,204\t\t# counts/pixel\n");
    correctStrings2.push_back("#h\t\t     10\t\tfixed\t\t# pixels\n");
  ...
  void testPrintParamsToString_with_errors( void )
  {
    ...
    correctStrings2.push_back("#FUNCTION Exponential\n");
    correctStrings2.push_back("#PA\t\t      0 # +/- 0.001\tdeg (CCW from +y axis)\n");
    correctStrings2.push_back("#ell\t\t    0.5 # +/- 0.002\n");
    correctStrings2.push_back("#I_0\t\t     50 # +/- 2.5\tcounts/pixel\n");
    correctStrings2.push_back("#h\t\t     10 # +/- 1.09\tpixels\n");
    correctStrings2.push_back("#FUNCTION FlatSky\n");
