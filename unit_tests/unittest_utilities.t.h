...
public:
  ...
  void testPrepareImageComments_NoPSF( void )
  {
    ...
    string  refLine1 = "Image generated by imfit v1.0";
  ...
  void testPrepareImageComments_WithPSF( void )
  {
    string  progName = "imfit v1.0";
    string  configFilename = "config.dat";
    ...
    string  refLine1 = "Image generated by imfit v1.0";
    string  refLine2 = "Using config file: config.dat";
    string  refLine3 = "Convolved with PSF image: some_psf.fits";
