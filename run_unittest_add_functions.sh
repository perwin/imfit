#! /bin/bash
cxxtestgen --error-printer -o test_runner.cpp unittest_add_functions.h
g++-4.8 -o test_runner test_runner.cpp add_functions.cpp model_object.cpp utilities.cpp convolver.o \
