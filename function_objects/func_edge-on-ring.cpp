...
/// parameters
void EdgeOnRing::AdjustParametersForImage( const double inputFunctionParams[], 
										double adjustedFunctionParams[], int offsetIndex )
{
  // PA, A, r1, sigma_r, sigma_z
...
void EdgeOnRing::Setup( double params[], int offsetIndex, double xc, double yc )
{
  ...
  r1 = params[2 + offsetIndex ] * pixelScaling;
  r2 = -r1;
  sigma_r = params[3 + offsetIndex ] * pixelScaling;
  sigma_z = params[4 + offsetIndex ] * pixelScaling;
