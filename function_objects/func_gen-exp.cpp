...
/// parameters
void GenExponential::AdjustParametersForImage( const double inputFunctionParams[], 
...
void GenExponential::Setup( double params[], int offsetIndex, double xc, double yc )
{
  ...
  I_0 = params[3 + offsetIndex] * intensityScale;
  h = params[4 + offsetIndex] * pixelScaling;
