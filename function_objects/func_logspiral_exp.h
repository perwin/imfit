/*   Class interface definition for func_logspiral_exp.cpp
 *   VERSION 0.1
 *
 ...
 * with the radial amplitude specified by an exponential for R > R_max and the
...
//#define CLASS_SHORT_NAME  "LogSpiralExp"


class LogSpiralExp : public FunctionObject
{
  ...
  private:
    double  x0, y0, PA, ell, m, i_pitch, R_i, sigma_az, gamma, I_max, h, R_max, sigma_trunc;   // parameters
    double  q, PA_rad, cosPA, sinPA, gamma_true, I_0;
