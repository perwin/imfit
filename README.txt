...
imfit-x.x-linux-64.tar.gz, etc.), copy the executable files imfit and makeimage 
to someplace convenient on your path. See docs/imfit_howto.pdf for detailed notes 
on how to use them.
